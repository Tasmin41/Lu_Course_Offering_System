        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <table id="example" class="display nowrap order-column" style="width: 100%;">
                    ...
                    <?php
                           include '../config.php';
                           $allData = mysqli_query($conn,"SELECT * FROM `batch_57` WHERE semester = 1");
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <table id="example" class="display nowrap order-column" style="width: 100%;">
                    ...
                    <?php
                           include '../config.php';
                           $allData = mysqli_query($conn,"SELECT * FROM `batch_57` WHERE semester = 2");
                           while($row=mysqli_fetch_array($allData)){   
				          ?>
                    <tr class="odd gradeX" >
							<td><?php echo $row['course_code'] ;?></td>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <table id="example" class="display nowrap order-column" style="width: 100%;">
                    ...
                    <?php
                           include '../config.php';
                           $allData = mysqli_query($conn,"SELECT * FROM `batch_57` WHERE semester = 3");
                           while($row=mysqli_fetch_array($allData)){   
				          ?>
                    <tr class="odd gradeX" >
							<td><?php echo $row['course_code'] ;?></td>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <table id="example" class="display nowrap order-column" style="width: 100%;">
                    ...
                    <?php
                           include '../config.php';
                           $allData = mysqli_query($conn,"SELECT * FROM `batch_57` WHERE semester = 4");
                           while($row=mysqli_fetch_array($allData)){   
				          ?>
                    <tr class="odd gradeX" >
							<td><?php echo $row['course_code'] ;?></td>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <table id="example" class="display nowrap order-column" style="width: 100%;">
                    ...
                    <?php
                           include '../config.php';
                           $allData = mysqli_query($conn,"SELECT * FROM `batch_57` WHERE semester = 5");
                           while($row=mysqli_fetch_array($allData)){   
				          ?>
                    <tr class="odd gradeX" >
							<td><?php echo $row['course_code'] ;?></td>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <table id="example" class="display nowrap order-column" style="width: 100%;">
                    ...
                    <?php
                           include '../config.php';
                           $allData = mysqli_query($conn,"SELECT * FROM `batch_57` WHERE semester = 6");
                           while($row=mysqli_fetch_array($allData)){   
				          ?>
                    <tr class="odd gradeX" >
							<td><?php echo $row['course_code'] ;?></td>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <table id="example" class="display nowrap order-column" style="width: 100%;">
                    ...
                    <?php
                           include '../config.php';
                           $allData = mysqli_query($conn,"SELECT * FROM `batch_57` WHERE semester = 7");
                           while($row=mysqli_fetch_array($allData)){   
				          ?>
                    <tr class="odd gradeX" >
							<td><?php echo $row['course_code'] ;?></td>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <table id="example" class="display nowrap order-column" style="width: 100%;">
                    ...
                    <?php
                           include '../config.php';
                           $allData = mysqli_query($conn,"SELECT * FROM `batch_57` WHERE semester = 8");
                           while($row=mysqli_fetch_array($allData)){   
				          ?>
                    <tr class="odd gradeX" >
							<td><?php echo $row['course_code'] ;?></td>
