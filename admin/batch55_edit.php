<?php
   ...
   $id = $_GET['id'];
   //echo $id;
   $dataFetchQuery = "SELECT * FROM `batch_55` WHERE id = '$id'";
			...
			<?php
              include 'config.php';
			    if(isset($_POST['submit'])){
                    ...
                    $updateQuery ="UPDATE batch_55 SET `course_code`= '$courseCode',`course_title`= '$courseTitle',`credit`= '$credit',`offer`= '$offered',`semester`='$semester' WHERE id = '$id'";
