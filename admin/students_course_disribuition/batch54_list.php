...
<head>
    ...
    <title>Batch 54 Course List</title>
    <!--data table css-->
   ...
   <nav class="navbar navbar-expand-lg navbar-light">
    ...
    <section class="body-area">
        <div class="container">
            ...
            <div class="col-xl-3 col-lg-3 col-ms-3 col-cm-12 col-12">
                    <div class="side-bar">
                ...
                <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12">
                    <div class="body">
                    <h2>Batch 54 course List</h2> 
                    <?php
                  include '../config.php';

                    if(isset($_POST['deleteData'])){
                        $deleteQuery = "TRUNCATE TABLE batch_54";
                    ...
                    while($row = mysqli_fetch_array($result)){
                        echo '
                            <tr>
                                ...
                                <td>'.$row["offer"].'</td>
                                <td>'.$row["semester"].'</td>					
                                <td><a href="batch54_edit.php?id='. $row['id'].'">Edit</a></td>
                            </tr>';
                        }
                        ?>
            </tbody>
