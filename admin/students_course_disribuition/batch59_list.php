...
<head>
    ...
    <title>Batch 59 Course List</title>
        ...
        <div class="container">
            ...
            <ul class="section menu">
                ...
                <div class="body col-xl-9 p0">
                    <h2>Batch 59 course List</h2>  
                    <?php
                  include '../config.php';

                    if(isset($_POST['deleteData'])){
                        $deleteQuery = "TRUNCATE TABLE batch_59";
                    ...
                    while($row = mysqli_fetch_array($result)){
                        echo '
                            <tr>
                                ...
                                <td>'.$row["offer"].'</td>
                                <td>'.$row["semester"].'</td>					
                                <td><a href="batch59_edit.php?id='. $row['id'].'">Edit</a></td>
                            </tr>';
                        }
                        ?>
            </tbody>
