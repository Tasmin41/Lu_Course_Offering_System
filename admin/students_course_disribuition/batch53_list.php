...
<head>
    ...
    <title>Batch 53 Course List</title>
    ...
    <section class="body-area">
        <div class="container">
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                ...
                <div class="body">
                <h2>Batch 53 course List</h2>  
                    <?php
                  include '../config.php';

                    if(isset($_POST['deleteData'])){
                        $deleteQuery = "TRUNCATE TABLE batch_53";
                    ...
                    while($row = mysqli_fetch_array($result)){
                        echo '
                            <tr>
                                ...
                                <td>'.$row["offer"].'</td>
                                <td>'.$row["semester"].'</td>					
                                <td><a href="batch53_edit.php?id='. $row['id'].'">Edit</a></td>
                            </tr>';
                        }
                        ?>
            </tbody>
